...
class GoodsCategory(models.Model):
    ...
    # 设置models有一个指向自己的外键
    parent_category = models.ForeignKey('self', verbose_name='父级目录', on_delete=models.CASCADE, null=True, blank=True,
                                        help_text='父目录', related_name='sub_cat')
    is_tab = models.BooleanField(verbose_name='是否导航', default=False, help_text='是否导航项')
...
class GoodsCategoryBrand(models.Model):
    ...
    category = models.ForeignKey(GoodsCategory, on_delete=models.CASCADE, related_name='brands', null=True, blank=True,
                                 verbose_name="商品类目")
    name = models.CharField(verbose_name="品牌名", default="", max_length=30, help_text="品牌名")
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name='商品描述', imagePath='goods/images/', width=800, height=600,
...
class IndexAd(models.Model):
    ...
    首页商品广告
    """
    category = models.ForeignKey(GoodsCategory, verbose_name='商品类目', on_delete=models.CASCADE, related_name='category')
